...
// ParsedRoute contains validated objects from a request path.
...
func (p *ParsedRoute) GetRouteName() string {
	if p.HTTPRoute != nil {
...
func (p *ParsedRoute) GetRouteNamespace() string {
	if p.HTTPRoute != nil {
...
func (p *ParsedRoute) GetRouteNamespacedName() k8stypes.NamespacedName {
...
func (p *ParsedRoute) GetRouteRuleName() string {
...
func (p *ParsedRoute) GetRouteRule() machinery.Object {
	if p.HTTPRouteRule != nil {
...
func (p *ParsedRoute) GetRouteRuleLocator() string {
	if p.HTTPRouteRule != nil {
...
// ParseRequestPath parses a request path and returns validated objects.
// It detects the route type and calls the appropriate parser.
func ParseRequestPath(path []machinery.Targetable) (*ParsedRoute, error) {
...
//
// Note: For new code, consider using ParseRequestPath which supports both HTTP and gRPC routes.
// This function will be migrated to ParseRequestPath once all policies have GRPCRoute support
