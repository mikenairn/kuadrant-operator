...
#
# Prerequisites:
#   - A cluster with kuadrant installed via OLM:
#       crc start
#       kubectl apply -k config/deploy/olm/
...
OPERATOR_IMG="${REGISTRY_ORG}/kuadrant-operator:olmv1-static-poc"
BUNDLE_IMG="${REGISTRY_ORG}/kuadrant-operator-bundle:olmv1-static-poc"
CATALOG_IMG="${REGISTRY_ORG}/kuadrant-operator-catalog:olmv1-static-poc"
OPM="./bin/opm"
YQ="./bin/yq"
